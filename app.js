...
const checkRow = () => {
    ...
    if (currentTile > 4) {
        if (!checkwords.includes(guess.toLowerCase())) {
            ...
            if (wordle == guess) {
                ...
                setTimeout(() => {
    				...
    				//window.open("https://youtu.be/ojATWxi4RME?t=37","_self")
                }, 3000)
                return
            } else {
                if (currentRow >= 5) {
                    ...
                    setTimeout(() => {
	                	document.getElementById('results').textContent = shareString;
	                	document.getElementById('resultTitle').textContent = "Sashay Away..."
	                	var box = document.getElementById('endContainer');
	            		box.style.display = 'block';
	    				//window.open("https://youtu.be/ojATWxi4RME?t=37","_self")
                	}, 3000)
...
const copyResults = () => {
    ...
    textarea.textContent = dailyMessage + shareString;
